...
function showscore(){
	...
	if (correctanswers == 16){
		scoretitle = "Amazing, you're a Map Genius!";
		...
		scoretitle = "Great job, you're a Map Nerd";
		scoredescr = "Not bad! Looks like you know your US States fairly well.";
	}else if (correctanswers >= 8 && correctanswers <= 11){
		scoretitle = "You're an Average Joe";
		scoredescr = "You did OK, but it looks like you need to study your map of the USA some more.";
	}else{
		scoretitle = "Wow, You Failed!";
		scoredescr = "Looks like it's time to study the map of the USA!";
	}
	...
	$("#quiz-area").append('<h4 class="text-center score-links"><a href="/world-map-quiz?ref=quizf">Now see how you do with World Maps!</a></h4>');
	$("#quiz-area").append('<p class="text-center"><a href="#" class="btn btn-default quiz-btn share-fb"><i class="fa fa-facebook "></i> Share on Facebook</a></p>');
	$("#quiz-area").append('<p class="text-center score-links"><a href="/us-map-quiz">Retake the Quiz</a> | <a href="/usa">US State Maps</a></p>');
}
