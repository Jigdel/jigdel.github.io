...
def plot_weather_data():
   ...
   However, due to the limitation of our Amazon EC2 server, we are giving you a random
    ...
    f = 'turnstile_data_master_with_weather.csv'
    turnstile_weather = pandas.read_csv(f)
    #data = turnstile_weather[1][3]
    #print(data)
    #print('this works!')
    '''
    ...
    limit_axes = xlim(0, 15000)
    p = ggplot(turnstile_weather, aes('EXITSn_hourly'))+ geom_histogram(binwidth = 1) + limit_axes + ggtitle('Histogram of hourly exits') + labs('Exits', 'Freq')
    ggsave('plot.png', p)
