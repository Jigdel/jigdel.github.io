...
ourHydro.controller('chartsCtrl', function ($scope) {
    ...
    $scope.hydroRevenueBreakdown = function () {
        $scope.highchartsNG = {
        options: {
            chart: {
                type: 'column'
        ...
        title: {
            text: 'Annual Revenue - Transmission vs Distribution'  
        },
        xAxis: {
        ...
        series: [{
            name: 'Transmission',
            data: [1.245,1.242,1.212,1.147,1.307,1.389,1.482,1.529]
        }, {
            name: 'Distribution',
            data: [3.273,3.382,3.334,3.534,3.754,4.019,4.184,4.484]
        }],
        credits: {
            enabled: false
        },
