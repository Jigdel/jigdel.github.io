###############################
# Author: Jigdel Kuyee, April 2016
# Version: 3.0
# Summary: The code provided below takes in raw csv and excel files containing asset 
# information of a typical electrical utility. These data are clean and completed, where
# necessary, using machine learning and industry domain expertise.
# Email: jigdel.k@gmail.com
###############################
...
dfTransformers['PCB'] = 49 #worst case scenario
...
# FILTER OUT ASSET CLASSES WITH THEIR RESPECTIVE SUBTYPES
#******************************************************
# NOTE TO SELF: To avoid index vs copy error: pd.DataFrame...necessary (spent 4 hours getting rid of the warning error!)
# UG Switches rows
...
#**************************************************************************************************************************************************************
# MACHINE LEARNING (ML) TO MAP INSTALLATION YEARS both OH and UG Transformers
#**************************************************************************************************************************************************************
#UG Tx: 2/3/5/7 - 1Ph/Ntwk/Sub/Pad 3Ph [1436,27,4,507: 1642 counts]
...
# VALIDATION: print('Blank OH Install years:', dfOHtx_XY['install_year'].isnull().sum()) # print number of blank rows
# separate empty and non-empty 'install_year' values
...
#*******EXCEL MODEL******************
# Defining new colummns for input table into risk model
...
#*****************************************************************************************************
# Pole attachments: Poles XY with TX, Switches
#*****************************************************************************************************
...
#*****************************************************************************************************
# Finding circuits for poles by matching with all nodes 
#*****************************************************************************************************
...
#*****************************************************************************************************
# ML to find first circuit for Poles
#*****************************************************************************************************
